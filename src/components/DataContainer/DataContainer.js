...
class DataContainer extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={classNames(s.root, s.animate, {[s.active]: this.props.active}, {[s.out]: this.props.events_shown})}>
	      <div className={s.nav}>
	        <p>Event</p>
	      ...
	      {this.props.event && <div className={s.data_container}>
	        <span className={s.timestamp}>{this.props.event.created_at}</span>
